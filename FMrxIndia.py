...
class FMrxIndia(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMrxIndia")
        ...
        self._freq_range = qtgui.Range(90e6, 102e6, 100e3, 98.5e6, 200)
        ...
        self.osmosdr_source_0.set_if_gain(45, 0)
        self.osmosdr_source_0.set_bb_gain(45, 0)
...
def main(top_block_cls=FMrxIndia, options=None):
