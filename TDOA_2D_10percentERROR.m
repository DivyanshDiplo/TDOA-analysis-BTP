...
% Introduce 1% error (for demonstration, add positive error)
d12 = d12_true * 1.50; % R1 to R2
d23 = d23_true * 0.90; % R2 to R3
d13 = d13_true * 1.10; % R1 to R3
...
xlabel('X (meters)');
ylabel('Y (meters)');
title('TDOA Hyperbolas for 3 Receivers (With 10-15% Error)');
axis equal; grid on;
