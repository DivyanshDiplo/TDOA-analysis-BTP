...
class Test 2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Test 2")
        ...
        self.soapy_hackrf_source_0.set_frequency(0, 98.3e6)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(98.3e6, self.samp_rate)
        self.soapy_hackrf_source_0.set_sample_rate(0, self.samp_rate)




def main(top_block_cls=Test 2, options=None):
