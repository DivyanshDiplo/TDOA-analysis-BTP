...
class Test2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Hello_World", catch_exceptions=True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate , 1e6, 50e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(98.3e6, (self.samp_rate/5))
        self.qtgui_freq_sink_x_1.set_frequency_range(98.3e6, self.samp_rate)
